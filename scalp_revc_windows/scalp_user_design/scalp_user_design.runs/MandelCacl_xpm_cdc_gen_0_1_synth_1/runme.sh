...
HD_PWD='C:/CochetVictorLPSC/scalp_revc_windows/scalp_user_design/scalp_user_design.runs/MandelCacl_xpm_cdc_gen_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MandelCacl_xpm_cdc_gen_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MandelCacl_xpm_cdc_gen_0_1.tcl
