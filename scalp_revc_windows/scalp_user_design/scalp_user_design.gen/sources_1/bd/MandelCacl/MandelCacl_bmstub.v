...
module MandelCacl (
  ...
  input Dest_Clk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.SRC_IN DATA" *)
  (* X_INTERFACE_MODE = "slave DATA.SRC_IN" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.SRC_IN, LAYERED_METADATA undef" *)
  input Src_In;
