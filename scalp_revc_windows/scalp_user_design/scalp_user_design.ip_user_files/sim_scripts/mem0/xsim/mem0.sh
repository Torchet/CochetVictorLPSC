...
#
# Script generated by Vivado on Sun Jun 01 18:03:51 +0200 2025
...
#
# Usage        : mem0.sh
#                mem0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mem0.sh [-reset_run]
#                mem0.sh [-reset_log]
#                mem0.sh [-help]
#
...
# script info
echo -e "mem0.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mem0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mem0 xil_defaultlib.mem0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mem0 -key {Behavioral:sim_1:Functional:mem0} -tclbatch cmd.tcl -protoinst "protoinst_files/MandelCacl.protoinst" -protoinst "protoinst_files/bd_c0d9.protoinst" -protoinst "protoinst_files/scalp_zynqps.protoinst" -protoinst "protoinst_files/vga_hdmi_clk_rst_system_inst_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mem0.wdb xsim.dir libdpi.so)
...
Usage: mem0.sh [-reset_log]\n\
Usage: mem0.sh [-keep_index]\n\
