...
#                script (type 'MandelCacl.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/CochetVictorLPSC/scalp_revc_windows/scalp_user_design/scalp_user_design.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
