...
#
# Script generated by Vivado on Mon Jun 02 21:21:00 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : MandelCacl.sh
...
#
# Usage        : MandelCacl.sh
#                MandelCacl.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                MandelCacl.sh [-reset_run]
#                MandelCacl.sh [-reset_log]
#                MandelCacl.sh [-help]
#
...
# script info
echo -e "MandelCacl.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./MandelCacl.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm_cdc_gen_v1_0_4 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot MandelCacl xil_defaultlib.MandelCacl xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim MandelCacl -key {Behavioral:sim_1:Functional:MandelCacl} -tclbatch cmd.tcl -protoinst "protoinst_files/MandelCacl.protoinst" -protoinst "protoinst_files/bd_c0d9.protoinst" -protoinst "protoinst_files/scalp_zynqps.protoinst" -protoinst "protoinst_files/vga_hdmi_clk_rst_system_inst_0.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb MandelCacl.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./MandelCacl.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: MandelCacl.sh [-help]\n\
Usage: MandelCacl.sh [-step]\n\
Usage: MandelCacl.sh [-lib_map_path]\n\
Usage: MandelCacl.sh [-reset_run]\n\
Usage: MandelCacl.sh [-reset_log]\n\
Usage: MandelCacl.sh [-keep_index]\n\
Usage: MandelCacl.sh [-noclean_files]\n\n\
