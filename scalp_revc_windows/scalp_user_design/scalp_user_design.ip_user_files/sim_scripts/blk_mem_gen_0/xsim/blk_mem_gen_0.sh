...
#
# Script generated by Vivado on Sun Jun 01 17:32:02 +0200 2025
...
simulate()
{
  xsim blk_mem_gen_0 -key {Behavioral:sim_1:Functional:blk_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_c0d9.protoinst" -protoinst "protoinst_files/scalp_zynqps.protoinst" -protoinst "protoinst_files/vga_hdmi_clk_rst_system_inst_0.protoinst" -log simulate.log
}
