...
module vga_hdmi_clk_rst_system_inst_0 (
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLKHDMIXCO, FREQ_HZ 241536458, FREQ_TOLERANCE_HZ 0, PHASE 0.0, ASSOCIATED_RESET ClkHdmiRstxRO:ClkHdmiRstxRNAO, INSERT_VIP 0, CLK_DOMAIN /vga_hdmi_clk_rst_sys_0/vga_hdmi_clock_clk_out1" *)
  output ClkHdmixCO;
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLKVGAXCO, FREQ_HZ 48007246, FREQ_TOLERANCE_HZ 0, PHASE 0.0, ASSOCIATED_RESET ClkVgaRstxRO:ClkVgaRstxRNAO, INSERT_VIP 0, CLK_DOMAIN /vga_hdmi_clk_rst_sys_0/vga_hdmi_clock_clk_out1" *)
  output ClkVgaxCO;
  ...
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.PSCLOCKXCI, FREQ_HZ 1.25e+08, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN scalp_zynqps_processing_system7_0_0_FCLK_CLK0, ASSOCIATED_RESET PsResetxRN, INSERT_VIP 0" *)
  input PsClockxCI;
